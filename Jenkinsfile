...
//               bat 'docker container logs -f usermysql'
				...
				powershell "docker exec -i mysqlstandalone mysql -uroot -pdevadeep -e "INSERT INTO bootdb.role VALUES (0, ROLE_USER);""
				powershell "docker exec -i mysqlstandalone mysql -uroot -pdevadeep -e "INSERT INTO bootdb.role VALUES (1, ROLE_ADMIN);""
