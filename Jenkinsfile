...
//               bat 'docker container logs -f usermysql'
				...
				bat 'docker exec -i  mysqlstandalone mysql -uroot -pdevadeep -e "USE bootdb;" -e "INSERT INTO bootdb.role VALUES (0,"ROLE_USER");"'
				bat 'docker exec -i  mysqlstandalone mysql -uroot -pdevadeep -e "USE bootdb;" -e "INSERT INTO bootdb.role VALUES (1,"ROLE_ADMIN");"'
